      ...
      <div className="flex flex-col items-center justify-between">
        ...
        <div className="mt-10 grid gap-14 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
          ...
          <div className="border-[2px] border-gray-300 bg-gray-100 drop-shadow-lg rounded-lg p-4 hover:shadow-xl">
            <img className="w-60 h-60 rounded-full mx-auto" src={"https://cdn.discordapp.com/attachments/451391528703623175/1128447107204911227/Fadhil.png"} alt="Profile Picture" />
            ...
            <div className="flex justify-center mt-4 gap-5">
              ...
              <a href="#" className=" text-gray-600 hover:text-slate-400 hover:underline text-2xl">Message</a>
            </div>
          </div>

          <div className="border-[2px] border-gray-300 bg-gray-100 drop-shadow-lg rounded-lg p-4 hover:shadow-xl">
            <img className="w-60 h-60 rounded-full mx-auto" src={"https://cdn.discordapp.com/attachments/451391528703623175/1128447107548848239/Handika.jpg"} alt="Profile Picture" />
            <div className="rounded-full bg-slate-700 h-1 mx-auto mt-3 mb-3"></div>
